...
kubectl set image deployments/client-deployment server=ajkris/multi-client:$SHA
kubectl set image deployments/worker-deployment server=ajkris/multi-worker:$SHA
